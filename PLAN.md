...
- [x] `vmuxctl notify <message>` CLI command — prints OSC 9 escape; works in any vmux pane
...
- [x] `vmuxctl` external CLI (named pipe `\\.\pipe\vmux-ipc`) — `vmuxctl notify`, `vmuxctl ping`, `vmuxctl list`
